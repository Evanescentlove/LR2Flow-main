...
class FlowStep(nn.Module):
    def __init__(self, in_channels, split_channels=None, cond_channels=None, flow_permutation='invconv', flow_coupling='Affine', LRvsothers=True,
        ...
        elif self.flow_coupling == 'Affine_':
            self.affine = AffineCouplings.AffineCoupling_(in_channels=in_channels, split_channels=split_channels, cond_channels=cond_channels,
                                                          LRvsothers=LRvsothers, opt=opt)
